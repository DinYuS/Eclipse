		...
		window.onload = function() {
			...
			document.getElementById("firstCb").onclick = function() {
				...
				for (var i=0; i<cbs.length; i++) {
					//设置这些你选中的cbs[i]的checked状态=dirstcb.checked
...
<body>
<div class="container">
    <h3 style="text-align: center">用户管理页面</h3>
    ...
    <!--  -->
		...
		<div style="float:right;margin:5px">
   		<a class="btn btn-primary" href="${pageContext.request.contextPath }/add.jsp">
   			添加联系人
   		</a>
   		
   		<%-- 多选批量删除 --%>
   		<a class="btn btn-primary" href="javascript:void(0);" id="delSelected">
   			删除选中
   		</a>
